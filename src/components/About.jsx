...
export default function About() {
  return (
    <section id='about'>
        <h1 className='text-xl font-semibold text-custom-text-1 px-4 py-2 md:p-1 block md:hidden'>About</h1>
...
Beyond technical skills, I'm passionate about Blender, video editing and enjoy hobbies like cycling. I prioritize continuous learning and staying updated with industry trends. I'm committed to using technology to tackle real-world challenges and enhance user experiences. Whether optimizing code or pioneering new features, I approach each project with dedication and a commitment to excellence.

Outside of work, I engage actively in the developer community, attending tech meetups and exploring emerging frameworks. I value teamwork and effective communication in achieving project success, always eager to tackle new challenges in software development.
        </p>
    </section>
  )
}
